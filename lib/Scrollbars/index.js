...
var Scrollbars = function (_Component) {
    ...
    _createClass(Scrollbars, [{
        ...
        value: function showTracks() {
            var trackHorizontal = this.trackHorizontal,
                trackVertical = this.trackVertical;
        ...
        value: function _update(callback) {
            ...
            var thumbHorizontal = this.thumbHorizontal,
                thumbVertical = this.thumbVertical,
                trackHorizontal = this.trackHorizontal,
                trackVertical = this.trackVertical,
        ...
        value: function render() {
            ...
            var viewStyle = _extends({}, styles.viewStyleDefault, {
                ...
                minHeight: autoHeightMin,
                maxHeight: autoHeightMax
            }, universal && !didMountUniversal && styles.viewStyleUniversalInitial, overrideDefaultViewStyle && _extends({}, viewStyles));

            var viewWrapperStyle = _extends({}, styles.viewWrapperStyleDefault, autoWidth && _extends({}, styles.viewWrapperStyleAutoHeight, {
                minWidth: autoWidthMin,
                maxWidth: autoWidthMax
            }));

            var viewWrappedStyle = _extends({}, styles.viewWrappedStyleDefault);
            ...
            var trackHorizontalStyle = _extends({}, styles.trackHorizontalStyleDefault, autoHide && trackAutoHeightStyle, universal && !didMountUniversal && {
                display: 'none'
            });

            var trackVerticalStyle = _extends({}, styles.trackVerticalStyleDefault, autoHide && trackAutoHeightStyle, universal && !didMountUniversal && {
                display: 'none'
            });
            ...
            return (0, _react.createElement)(tagName, _extends({}, props, { style: containerStyle, ref: function ref(_ref2) {
                    ...
                    _this6.trackHorizontal = _ref4;
                } }, (0, _react.cloneElement)(renderThumbHorizontal({ style: styles.thumbHorizontalStyleDefault }), { ref: function ref(_ref5) {
                    _this6.thumbHorizontal = _ref5;
                } })), (0, _react.cloneElement)(renderTrackVertical({ style: styles.trackVerticalStyleDefault }), { key: 'trackVertical', ref: function ref(_ref6) {
                    _this6.trackVertical = _ref6;
                } }, (0, _react.cloneElement)(renderThumbVertical({ style: styles.thumbVerticalStyleDefault }), { ref: function ref(_ref7) {
                    _this6.thumbVertical = _ref7;
                } }))]);
        }
    }]);
...
Scrollbars.defaultProps = {
    ...
    renderTrackHorizontal: function renderTrackHorizontalDefault(_ref8) {
        var style = _ref8.style,
            props = _objectWithoutProperties(_ref8, ['style']);
    ...
    renderTrackVertical: function renderTrackVerticalDefault(_ref9) {
    ...
    renderThumbHorizontal: function renderThumbHorizontalDefault(_ref10) {
        var style = _ref10.style,
            props = _objectWithoutProperties(_ref10, ['style']);
    ...
    renderThumbVertical: function renderThumbVerticalDefault(_ref11) {
        var style = _ref11.style,
            props = _objectWithoutProperties(_ref11, ['style']);
